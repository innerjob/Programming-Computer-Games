...
public class World3 extends Applet {
     ...
     public BranchGroup createSceneGraph() {
        ...
        // Add two spheres, drawn as wireframes.
        PolygonAttributes polyAttr = new PolygonAttributes();
        polyAttr.setPolygonMode(PolygonAttributes.POLYGON_LINE);
        Appearance appS = new Appearance();
		appS.setPolygonAttributes(polyAttr);
		...
		return objRoot;
    } // end of CreateSceneGraph method of World3
    ...
    public static void main(String[] args) {
        Frame frame = new MainFrame(new World3(), 256, 256);
    } // end of main (method of World3)
